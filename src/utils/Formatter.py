...
from src.utils.Constants import DEFAULT_COLOR, DEFAULT_CELL_COLOR, DEFAULT_FONT

def format_text(run, font_size, color=DEFAULT_COLOR, bold_status=False, underline_status=False, italicize=False):
    """
...
def format_table_text(table, font_size, color=DEFAULT_COLOR, bold=False, underline=False, italics=False):
    """
